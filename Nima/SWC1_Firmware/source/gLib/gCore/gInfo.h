 ...
 */
#define GINFO_CONFIG_CHECK_WORD       0x0988CDA5
...
typedef struct
{
  ...
  char                                sn[32];
  uint8_t                             iv[16];
  uint8_t                             reserved[428];                ///< reserved for future use
