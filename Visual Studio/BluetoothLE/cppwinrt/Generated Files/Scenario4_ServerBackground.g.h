...
namespace winrt::SDKTemplate::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Scenario4_ServerBackground_base : implements<D, SDKTemplate::Scenario4_ServerBackground, composing, winrt::Windows::UI::Xaml::Controls::IPageOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides6, winrt::Windows::UI::Xaml::IFrameworkElementOverrides, winrt::Windows::UI::Xaml::IFrameworkElementOverrides2, winrt::Windows::UI::Xaml::IUIElementOverrides, winrt::Windows::UI::Xaml::IUIElementOverrides7, winrt::Windows::UI::Xaml::IUIElementOverrides8, winrt::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = Scenario4_ServerBackground_base;
        using class_type = SDKTemplate::Scenario4_ServerBackground;
        using implements_type = typename Scenario4_ServerBackground_base::implements_type;
        ...
        {
            return L"SDKTemplate.Scenario4_ServerBackground";
        }
        Scenario4_ServerBackground_base()
        {
...
namespace winrt::SDKTemplate::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Scenario4_ServerBackgroundT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = SDKTemplate::Scenario4_ServerBackground;
...
#if defined(WINRT_FORCE_INCLUDE_SCENARIO4_SERVERBACKGROUND_XAML_G_H) || __has_include("Scenario4_ServerBackground.xaml.g.h")

#include "Scenario4_ServerBackground.xaml.g.h"
...
{
    template <typename D, typename... I>
    using Scenario4_ServerBackgroundT = Scenario4_ServerBackground_base<D, I...>;
}
