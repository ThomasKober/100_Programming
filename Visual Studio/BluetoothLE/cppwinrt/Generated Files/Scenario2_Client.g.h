...
namespace winrt::SDKTemplate::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Scenario2_Client_base : implements<D, SDKTemplate::Scenario2_Client, composing, winrt::Windows::UI::Xaml::Controls::IPageOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides6, winrt::Windows::UI::Xaml::IFrameworkElementOverrides, winrt::Windows::UI::Xaml::IFrameworkElementOverrides2, winrt::Windows::UI::Xaml::IUIElementOverrides, winrt::Windows::UI::Xaml::IUIElementOverrides7, winrt::Windows::UI::Xaml::IUIElementOverrides8, winrt::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = Scenario2_Client_base;
        using class_type = SDKTemplate::Scenario2_Client;
        using implements_type = typename Scenario2_Client_base::implements_type;
        ...
        {
            return L"SDKTemplate.Scenario2_Client";
        }
        Scenario2_Client_base()
        {
...
namespace winrt::SDKTemplate::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Scenario2_ClientT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = SDKTemplate::Scenario2_Client;
...
#if defined(WINRT_FORCE_INCLUDE_SCENARIO2_CLIENT_XAML_G_H) || __has_include("Scenario2_Client.xaml.g.h")

#include "Scenario2_Client.xaml.g.h"
...
{
    template <typename D, typename... I>
    using Scenario2_ClientT = Scenario2_Client_base<D, I...>;
}
