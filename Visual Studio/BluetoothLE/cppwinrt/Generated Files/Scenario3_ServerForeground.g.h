...
namespace winrt::SDKTemplate::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Scenario3_ServerForeground_base : implements<D, SDKTemplate::Scenario3_ServerForeground, composing, winrt::Windows::UI::Xaml::Controls::IPageOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides, winrt::Windows::UI::Xaml::Controls::IControlOverrides6, winrt::Windows::UI::Xaml::IFrameworkElementOverrides, winrt::Windows::UI::Xaml::IFrameworkElementOverrides2, winrt::Windows::UI::Xaml::IUIElementOverrides, winrt::Windows::UI::Xaml::IUIElementOverrides7, winrt::Windows::UI::Xaml::IUIElementOverrides8, winrt::Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = Scenario3_ServerForeground_base;
        using class_type = SDKTemplate::Scenario3_ServerForeground;
        using implements_type = typename Scenario3_ServerForeground_base::implements_type;
        ...
        {
            return L"SDKTemplate.Scenario3_ServerForeground";
        }
        Scenario3_ServerForeground_base()
        {
...
namespace winrt::SDKTemplate::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Scenario3_ServerForegroundT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = SDKTemplate::Scenario3_ServerForeground;
...
#if defined(WINRT_FORCE_INCLUDE_SCENARIO3_SERVERFOREGROUND_XAML_G_H) || __has_include("Scenario3_ServerForeground.xaml.g.h")

#include "Scenario3_ServerForeground.xaml.g.h"
...
{
    template <typename D, typename... I>
    using Scenario3_ServerForegroundT = Scenario3_ServerForeground_base<D, I...>;
}
