...
const GInfoConfigStorageStruct ginfo_config_initialize_ =
{
  ...
  .is_constant_trig = true,
  .trig_length = GVIB_TRIG_LENGTH_DEFAULT,
  .max_ch = GVIB_MAX_CH_DEFAULT,
  .voltage_mv = MP8859_VOLTAGE_DEFAULT,
  .current_ma = MP8859_CURRENT_DEFAULT,
  .led_off_duration = GVIB_LED_OFF_TIME_DEFAULT,
  .led_on_duration = GVIB_LED_ON_TIME_DEFAULT,
